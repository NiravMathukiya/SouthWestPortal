...
const BookingsPage: React.FC = () => {
    ...
    return (
        <>
            <BookingHeader title="Bookings" handleDelete={handleDelete} />
            ...
            {loading ? (
                ...
                <SkeletonTable rowCount={8} rowHeight="h-4" rowWidths={["w-1/6", "w-2/6", "w-1/6", "w-1/6", "w-1/6", "w-1/6", "w-1/6", "w-1/6"]} />
            ) : (
                <DynamicTable
                    columns={columns}
                    data={bookings}
