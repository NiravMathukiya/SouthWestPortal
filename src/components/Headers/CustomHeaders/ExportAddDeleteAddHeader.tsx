...
interface HeaderProps {
    ...
    handleDelete?: () => void;
    handleAddFirstUrl?: string;
    handleAddSecondUrl?: string;
}

const ExportAddDeleteHeader: React.FC<HeaderProps> = ({ title, HandleExcelExport, HandlePdfExport, handleAddFirstUrl, handleAddSecondUrl, handleDelete }) => {
    return (
...
export default ExportAddDeleteHeader